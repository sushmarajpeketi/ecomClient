...
const Signin = () => {
  ...
  const submitHandler = async() => {
    ...
    try{
        const res = await axios.post('http://localhost:3000/users/sign-in',user,{ withCredentials: true })
        ...
        setGlobalUser({username:userDetails.data.username,email:userDetails.data.email})
        navigate('/')
